...
class MadrasaComponent extends Component
{
    use WithPagination;
    ...
    {
        $madrasas = Job::where('type', 'madrasa')->where('status', 'active')->
        ...
        return view('livewire.web.show.madrasa-component', compact('madrasas', 'setup', 'divisions'));
    }
}
