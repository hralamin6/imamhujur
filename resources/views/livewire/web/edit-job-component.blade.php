...
<div>
    <div class="m-2 px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800 ">
        <div class="flex gap-3 flex-wrap justify-center">
            ...
            <a wire:click.prevent="$set('currentPage', 3)" class="font-semibold {{$currentPage==3?'bg-indigo-700 px-2 pb-1 text-white rounded-md':'text-info'}}">{{__("Profession")}}</a>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 5l7 7-7 7M5 5l7 7-7 7" />
            </svg>
            <a wire:click.prevent="$set('currentPage', 4)" class="font-semibold {{$currentPage==4?'bg-indigo-700 px-2 pb-1 text-white rounded-md':'text-info'}}">{{__("Qualification")}}</a>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 5l7 7-7 7M5 5l7 7-7 7" />
            </svg>
            <a wire:click.prevent="$set('currentPage', 5)" class="font-semibold {{$currentPage==5?'bg-indigo-700 px-2 pb-1 text-white rounded-md':'text-info'}}">{{__("Opinion")}}</a>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 5l7 7-7 7M5 5l7 7-7 7" />
            </svg>
            <a wire:click.prevent="$set('currentPage', 6)" class="font-semibold {{$currentPage==6?'bg-indigo-700 px-2 pb-1 text-white rounded-md':'text-info'}}">{{__("Preference")}}</a>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 5l7 7-7 7M5 5l7 7-7 7" />
            </svg>
            <a wire:click.prevent="$set('currentPage', 7)" class="font-semibold {{$currentPage==7?'bg-indigo-700 px-2 pb-1 text-white rounded-md':'text-info'}}">{{__("Attachment")}}</a>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 5l7 7-7 7M5 5l7 7-7 7" />
            </svg>
            <a wire:click.prevent="$set('currentPage', 8)" class="font-semibold {{$currentPage==8?'bg-indigo-700 px-2 pb-1 text-white rounded-md':'text-info'}}">{{__("Commitment")}}</a>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 5l7 7-7 7M5 5l7 7-7 7" />
            </svg>
            <a wire:click.prevent="$set('currentPage', 9)" class="font-semibold {{$currentPage==9?'bg-indigo-700 px-2 pb-1 text-white rounded-md':'text-info'}}">{{__("Submit")}}</a>
        </div>
    </div>
    ...
    <div class="mx-3 px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800 grid lg:grid-cols-2 grid-cols-1 lg:gap-3">
        ...
        @if ($currentPage===6)
            ...
            <label class="block mt-3">
                ...
                <input type="text" wire:model.lazy="location_of_job" class="form-control-tw @error('location_of_job') is-invalid @enderror form-input" placeholder="{{__("From where you want to get mosque?")}}">
        ...
        @if($currentPage===7)
            ...
            <label class="block mt-3">
                <div class="list-inline flex justify-between"  x-data="{ isUploading: false, progress: 0 }" x-on:livewire-upload-start="isUploading = true" x-on:livewire-upload-finish="isUploading = false" x-on:livewire-upload-error="isUploading = false" x-on:livewire-upload-progress="progress = $event.detail.progress">
                    ...
                    @elseif($job->getFirstMediaUrl('hand_writing')!=null)
                        <img style="height: 66px; width: 66px;" src="{{$job->getFirstMediaUrl('hand_writing', "thumb")}}" alt="">
                    @endif
                </div>
            </label>
            ...
            <label class="block mt-3">
                <div class="list-inline flex justify-between"  x-data="{ isUploading: false, progress: 0 }" x-on:livewire-upload-start="isUploading = true" x-on:livewire-upload-finish="isUploading = false" x-on:livewire-upload-error="isUploading = false" x-on:livewire-upload-progress="progress = $event.detail.progress">
                    ...
                    @elseif($job->getFirstMediaUrl('certificate')!=null)
                        <img style="height: 66px; width: 66px;" src="{{$job->getFirstMediaUrl('certificate', "thumb")}}" alt="">
                    @endif
                </div>
            </label>
            ...
            <label class="block mt-3">
                <div class="list-inline flex justify-between"  x-data="{ isUploading: false, progress: 0 }" x-on:livewire-upload-start="isUploading = true" x-on:livewire-upload-finish="isUploading = false" x-on:livewire-upload-error="isUploading = false" x-on:livewire-upload-progress="progress = $event.detail.progress">
                    ...
                    @elseif($job->getFirstMediaUrl('recitation')!=null)
                        <audio controls>
        ...
        @endif
        @if($currentPage===9)
            <div class="text-lg font-semibold px-6 mx-auto text-center"><span>{{__('Please be careful, You will not be able to edit your job after submitting')}}</span></div>
        @endif
    </div>
