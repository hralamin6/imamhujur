@section('title', __('Biodata of all teacher'))
@section('description', __('Easily find your preferred one from all teacher'))
@section('image', $setup->getFirstMediaUrl('teacher'))
@section('url', config('app.url').'/teacher')
<div>
    ...
    <div>
        <h1 class="dark:text-white text-indigo-800 font-semibold m-2 text-center">{{__('Biodata of all Teacher')}}</h1>
            ...
            @forelse($teachers as $teacher)
                <div class="border-2 border-purple-600 rounded-md shadow-md m-3">
                    ...
                    <div class="flex items-center justify-center m-2">
                        <a href="{{route('show.job', $teacher)}}" class="bg-blue-700 py-2 px-4 rounded-full text-white text-sm font-semibold hover:bg-purple-700 transition">
                            {{__("View Details")}}
                        </a>
                    </div>
                </div>
