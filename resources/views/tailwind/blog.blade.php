    ...
    <div class="container mx-auto px-4 flex flex-wrap lg:flex-nowrap">
        ...
        <div class="xl:w-6/12 w-full lg:w-8/12  lg:mx-6">
            <div class="bg-white px-3 py-2 flex shadow-md rounded-md flex justify-between items-center">
                ...
                <a href="#" class="text-sm font-semibold text-white bg-blue-400 px-2 py-1 rounded-md transition hover:bg-blue-800 font-sans ml-auto">See more</a>
            </div>
            ...
            <div class="grid lg:grid-cols-3 grid-cols-1 mt-3 space-x-2">
                <div class="bg-white my-3 pt-0 shadow-md rounded-md">
                    <a class="overflow-hidden block" href="#">
                        <img class="w-full h-36 rounded object-cover  transform hover:scale-110 transition duration-500" src="{{asset('frontend/images/blog/img-4.jpg')}}" alt="">
                    </a>
                    <div class="p-2">
                        <a href="#" class="hover:text-blue-500 transition">
                            <h3 class="font-serif text-sm font-semibold text-gray-800">Lorem ipsum dolor sit amet, consectetur adipisicing elit. !</h3>
                        </a>
                        <div class="flex items-center text-gray-500 text-xs mt-2 space-x-5">
                            <span><i class="far fa-user"></i><span class="text-indigo-500 ml-2">Asadfk</span></span>
                            <span class="pr-2"><i class="far fa-clock"></i></span>June,12,2020
            ...
            <div class="bg-white mb-9 p-4 shadow-md rounded-md">
                <h3 class="text-lg font-semibold text-gray-700 font-sans mb-3">Post a comment</h3>
                <p class="text-sm text-gray-500 ">(12) comments</p>
                <div>
                    <div class="py-4 flex items-start">
                        <div class="flex-shrink-0">
                            <img class="w-16 h-16 rounded-full" src="{{asset('frontend/images/about/team-2.jpg')}}" alt="">
                        </div>
                        <div class="flex-grow pl-6">
                            <h4 class="text-base text-gray-800 font-semibold font-serif">Aalkdsf</h4>
                            <p class="text-sm text-gray-500">june.12 2020</p>
                            <p class="text-sm mt-2">THis was a great artisanle</p>
                            <div class="flex mt-2 space-x-2">
                                <button class="text-gray-500 px-1 text-xs border-gray-200 rounded-sm shadow-sm hover:bg-blue-500 hover:text-white">Edit</button>
                                <button class="text-gray-500 px-1 text-xs border-gray-200 rounded-sm shadow-sm hover:bg-blue-500 hover:text-white">Delete</button>
                            </div>
                        </div>
                    </div>
                    <div class="py-4 flex items-start">
                ...
                <h3 class="text-lg font-semibold text-gray-700 font-sans mb-3">Post a comment</h3>
                <div>
                    <textarea class="w-full text-gray-500" name="" id="" cols="30" rows="2">What do you want to say?</textarea>
                    <button class="px-2 py-1 text-white hover:bg-blue-800 bg-blue-500 rounded mt-3">Submit</button>
                </div>
            </div>
        </div>
