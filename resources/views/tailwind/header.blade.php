...
{{--        <div class="container mx-auto px-4 py-1 flex items-center">--}}
        <div class="w-30 mr-auto">
            <a href="{{route('home')}}"><img class="w-full" src="{{asset('frontend/images/logo.svg')}}" alt="logo"></a>
        </div>
        ...
        <ul class="flex items-center flex-shrink-0 space-x-6">
            <!-- Theme toggler -->
            <li class="flex">
                <button  wire:click.prevent="ChangeLang">{{session()->get('locale')=='en'?'BN':'EN'}}
